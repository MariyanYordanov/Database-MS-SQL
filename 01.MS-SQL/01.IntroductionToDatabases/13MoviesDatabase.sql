...
(2, 'Fiction', 'Science fiction (sometimes shortened to sci-fi or SF) is a genre of speculative fiction which typically deals with imaginative and futuristic 
 concepts such as advanced science and technology, space exploration, time travel, parallel universes, and extraterrestrial life. It has been called the 
 "literature of ideas", and it often explores the potential consequences of scientific, social, and technological innovations'),
(3, 'Art', 'An art film (or art house film) is typically an independent film, aimed at a niche market rather than a mass market audience.[1] It is "intended 
 to be a serious, artistic work, often experimental and not designed for mass appeal",[2] "made primarily for aesthetic reasons rather than commercial profit",
 [3] and contains "unconventional or highly symbolic content"'),
